module.exports = {
  ...
  plugins: ['@typescript-eslint', 'prettier', 'import', 'compat', 'unicorn', 'sonarjs', 'react', 'react-hooks'],
  ...
  //         {
  //           name: 'axios',
  //           message: 'Используйте request из @platform/services',
  //           allowTypeImports: true,
  //         },
  //         {
  //           name: 'enzyme',
  //           message: 'Используйте @testing-library',
  //         },
  //       ],
  //       patterns: [
  //         {
  //           group: ['@eco/**/dist-types', '@gbo/**/dist-types', '@platform/**/dist-types', '@fractal-ui/**/dist-types'],
  //           message: 'Импорт типов из dist-types запрещен.',
  //         },
  //       ],
  //     },
  //   ],
